...
import { getSecteurforAllProgrammeByUser } from "../utils/api";
import AuthContext from "../context/AuthContext";


const SecteurProgrammesUser = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await getSecteurforAllProgrammeByUser(user.user_id);
...
export default SecteurProgrammesUser;